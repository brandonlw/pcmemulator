...
namespace PCMEmulator
{
    partial class Emulator
    {
        void BuildOpcodeTable()
        {
            ...
            Assign("tst", TST, "01001010", "Size2_1", "OAmXn_Duplicate");
            ...
            Assign("divu", DIVU_WORD, "1000", "Xn", "011", "MAmXn");
            Assign("divu", DIVU_LONG, "0100110001", "AlmostEverything");
            Assign("mulu", MULU_LONG, "0100110000", "AlmostEverything");
            Assign("movec", MOVEC, "010011100111101", "Size1");
            Assign("rtd", RTD, "0100111001110100");
            ...
            Assign("mulu", MULU_WORD, "1100", "Xn", "011", "MAmXn");
            ...
            Assign("tblu", TBLU, "1111100000", "TableModes");//, "0", "Data3", "0", "Size1", "01", "Size2_1", "000000");
            Assign("extb", EXTB, "0100100", "OpModes", "000", "Xn");
        }
        ...
        void Assign(string instr, Action exec, string root, params string[] bitfield)
        {
            ...
            foreach (var component in bitfield)
            {
                ...
                else if (component == "AlmostEverything") opList = AppendPermutations(opList, AlmostEverything);
                ...
                else if (component == "OAmXn_Duplicate") opList = AppendPermutations(opList, OAm3Xn3_Duplicate);//0,2-6,7_0-7_1
                ...
                else if (component == "TableModes") opList = AppendPermutations(opList, TableModes);
                else if (component == "OpModes") opList = AppendPermutations(opList, OpModes);
            }
        ...
        static readonly string[] OpModes = { "010", "011", "111" };
        ...
        static readonly string[] TableModes =
        {
            "000000", // Dn   Data register
            "000001",
            "000010",
        ...
        static readonly string[] OAm3Xn3_Duplicate = {
            "000000", // Dn   Data register
            "000001",
            "000010",
            "000011",
        ...
        static readonly string[] AlmostEverything = {
            "000000", // Dn   Data register
            "000001",
            "000010",
            "000011",
